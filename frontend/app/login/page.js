  ...
  return (
    <main className={styles.authPage}>
      ...
      <header className={styles.authHeader}>
        ...
        <span className={styles.authHeaderNav}>Secure Login</span>
      </header>

      {/* Main */}
      <div className={styles.authMain}>
        <h1 className={styles.authHeading}>Welcome Back</h1>
        <p className={styles.authTagline}>Your trusted partner in Pakistani banking</p>
          ...
          <div className={styles.logoSection}>
            <div className={styles.logoIcon}>
              <svg width="40" height="40" viewBox="0 0 48 48" fill="none">
                ...
                <defs><linearGradient id="lg" x1="0" y1="0" x2="48" y2="48"><stop stopColor="#d4af37"/><stop offset="1" stopColor="#b8860b"/></linearGradient></defs>
              </svg>
            </div>
            <h2 className={styles.authTitle}>Sign in to your AI Banking Advisor</h2>
          </div>
